...
__ANY_NUM(__add)
__ANY_NBIT(__add) // liurundan add +/* for BYTE
...
#define __in1_anyint_(in2_TYPENAME)   __ANY_INT_1(__iec_,in2_TYPENAME) // liurundan
...
#define __iec_(in1_TYPENAME,in2_TYPENAME) \
__shift_(SHL__##in1_TYPENAME##__##in1_TYPENAME##__##in2_TYPENAME, in1_TYPENAME, in2_TYPENAME, << )/* Overloaded function */
__ANY_INT(__in1_anyint_) // liurundan add for UINT
#undef __iec_
  /**************/
  /*     SHR    */
  /**************/
