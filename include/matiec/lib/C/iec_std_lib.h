...
//}
static inline TIME __time_mul(TIME IN1, LREAL IN2) {
    int64_t total_ns = (int64_t)IN1.tv_sec * 1000000000LL + IN1.tv_nsec;
    int64_t new_total_ns = (int64_t)round(total_ns * IN2);
    TIME res;
    res.tv_sec = (long)(new_total_ns / 1000000000LL);
    res.tv_nsec = (long)(new_total_ns % 1000000000LL);
