...
#define __decl_enum_field(TYPENAME) TYPENAME##_F_ENUM,
#define __decl_enum_locarray(TYPENAME) TYPENAME##_L_ENUM,
typedef enum{
  __ANY(__decl_enum_type)
  __ANY(__decl_enum_pointer)
  __ANY(__decl_enum_output)
  __ANY(__decl_enum_field)
  __ANY(__decl_enum_locarray)
