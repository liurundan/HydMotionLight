...
typedef struct {
  ...
  __DECLARE_VAR(WORD,_FRAMEWORK_GENERATION)

} HYD_CREATEMOTION;

// FUNCTION_BLOCK HYD_CONFIGURETOGGLEMECHANISM
// Data part
typedef struct {
  // FB Interface - IN, OUT, IN_OUT variables
  __DECLARE_VAR(BOOL,EN)
  ...
  __DECLARE_VAR(SINT,AXISID)
  __DECLARE_VAR(BOOL,EXECUTE)
  __DECLARE_VAR(LREAL,LR)
  __DECLARE_VAR(LREAL,LF)
  __DECLARE_VAR(LREAL,LPF)
  __DECLARE_VAR(LREAL,LPK)
  __DECLARE_VAR(LREAL,LD)
  __DECLARE_VAR(LREAL,HF)
  __DECLARE_VAR(LREAL,HM)
  __DECLARE_VAR(LREAL,DC)
  __DECLARE_VAR(LREAL,SM)
  __DECLARE_VAR(LREAL,XHANDOFF)
  __DECLARE_VAR(SINT,SIGMA_K)
  __DECLARE_VAR(SINT,SIGN_B)
  __DECLARE_VAR(SINT,TAU_S)
  __DECLARE_VAR(SINT,SIGMA_C)
  __DECLARE_VAR(BOOL,DONE)
  __DECLARE_VAR(BOOL,BUSY)
  __DECLARE_VAR(BOOL,ERROR)
  __DECLARE_VAR(WORD,ERRORID)
  __DECLARE_VAR(WORD,CONFIG_VERSION)

  // FB private variables - TEMP, private and located variables
  __DECLARE_VAR(BOOL,EXECUTE0)
  __DECLARE_VAR(USINT,VALIDATION_TOKEN)
  __DECLARE_VAR(BOOL,ACTIVE)
  __DECLARE_VAR(SINT,CONFIG_AXIS)
  __DECLARE_VAR(WORD,_FRAMEWORK_GENERATION)

} HYD_CONFIGURETOGGLEMECHANISM;

// FUNCTION_BLOCK HYD_READTOGGLEMECHANISM
// Data part
typedef struct {
  // FB Interface - IN, OUT, IN_OUT variables
  __DECLARE_VAR(BOOL,EN)
  ...
  __DECLARE_VAR(BOOL,USING_DEFAULTS)
  __DECLARE_VAR(LREAL,LR)
  __DECLARE_VAR(LREAL,LF)
  __DECLARE_VAR(LREAL,LPF)
  __DECLARE_VAR(LREAL,LPK)
  ...
  __DECLARE_VAR(SINT,SIGMA_C)
  __DECLARE_VAR(WORD,CONFIG_VERSION)
  __DECLARE_VAR(LREAL,X_GEOMETRY_MIN)
  __DECLARE_VAR(LREAL,X_HANDOFF_EFFECTIVE)
  __DECLARE_VAR(LREAL,XS_MIN)
  __DECLARE_VAR(LREAL,XS_MAX)
  __DECLARE_VAR(LREAL,K_MIN)
  __DECLARE_VAR(LREAL,K_MAX)
  __DECLARE_VAR(BOOL,ERROR)
  __DECLARE_VAR(WORD,ERRORID)
...
typedef struct {
  ...
  __DECLARE_VAR(SINT,MECHANISMTYPE)
  __DECLARE_VAR(SINT,ACTUATORDIRECTION)
  __DECLARE_VAR(REAL,ACTUATORPOSITION)
  __DECLARE_VAR(REAL,ACTUATORVELOCITYCOMMAND)
  __DECLARE_VAR(REAL,VELOCITYRATIO)
  __DECLARE_VAR(WORD,MECHANISMCONFIGVERSION)
  __DECLARE_VAR(REAL,REQUESTEDFLOW)
  __DECLARE_VAR(REAL,MAXFLOW)
  __DECLARE_VAR(REAL,MAXTEMPLATEVELOCITY)
  __DECLARE_VAR(REAL,EFFECTIVECYLINDERGAIN)
  __DECLARE_VAR(BOOL,FLOWLIMITACTIVE)
  __DECLARE_VAR(BOOL,PUMPSPEEDLIMITACTIVE)
  __DECLARE_VAR(BOOL,PRESSURELIMITACTIVE)
  __DECLARE_VAR(BOOL,SOFTLIMITACTIVE)
  __DECLARE_VAR(BOOL,DERATED)
...
extern void __mcl_cmd_ConfigureToggleMechanism(
    HYD_CONFIGURETOGGLEMECHANISM *data__);
extern void __mcl_cmd_ReadToggleMechanism(HYD_READTOGGLEMECHANISM *data__);
