...
{
    static HDY_TIME _lastPublishTime = 0.0;
    HDY_TIME currentTime = HDY_MotionControlFB_inst[0].AXIS_REF.timestamp;
    HDY_TIME deltaTime;
...
void __mcl_cmd_GetPumpRequest(HDY_GETPUMPREQUEST *data__)
{
